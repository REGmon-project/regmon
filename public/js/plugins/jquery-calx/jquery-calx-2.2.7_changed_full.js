...
date: {
    ...
    DATEDIFF : function (start_date, end_date, period) {
        ...
        // return moment(end_date).diff(moment.utc(start_date), period); //@@@@@MAD
        return moment(end_date).diff(moment(start_date), period); //@@@@@MAD
    },
...
statistic: {
    ...
    COUNTIF : function(range, criteria) {
        var matches = 0, i;
        for (i in range) {
            // if (range[i].match(new RegExp(criteria))) { //@@@@@MAD
            if (String(range[i]).match(new RegExp(criteria))) { //@@@@@MAD
                matches++;
            }
        }
        return matches;
