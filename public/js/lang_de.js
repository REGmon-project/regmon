LANG = {
	...
	RESULTS : {
		...
		//
		EXPORT_FORMS_FILE_NAME 	: '{TODAY}_REGMON_Formular-Ergebnisse_{ATHLETE_NAME}',
		EXPORT_RESULTS_FILE_NAME: '{TODAY}_REGMON_Ergebnisse_{ATHLETES_NAMES}',
	},

	DIAGRAM : {
		LOADING 				: 'Lädt...',
		NO_DATA_SELECTED 		: 'Nichts ausgewählt oder anzuzeigen.',
		EXPORT_FORMS_FILE_NAME 	: '{TODAY}_REGMON_Formular-Ergebnisse_Diagram_{ATHLETE_NAME}',
		EXPORT_RESULTS_FILE_NAME: '{TODAY}_REGMON_Ergebnisse_Diagram_{ATHLETES_NAMES}',
		EXPORT_MENU_TITLE		: 'Diagramm Export-Menü',
		DOWNLOAD_PNG_IMAGE 		: 'Bild herunterladen (PNG)',
		DOWNLOAD_JPEG_IMAGE		: 'Bild herunterladen (JPEG)',
		DOWNLOAD_PDF_DOC 		: 'Vektorgrafik herunterladen (PDF)',
		DOWNLOAD_SVG_IMAGE 		: 'Vektorgrafik herunterladen (SVG)',
		DOWNLOAD_CSV_DOC 		: 'Daten herunterladen (CSV)',
		DOWNLOAD_XLSX_DOC 		: 'Daten herunterladen (Excel)',
