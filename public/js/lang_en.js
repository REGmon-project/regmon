LANG = {
	...
	DIAGRAM : {
		...
		DOWNLOAD_PNG_IMAGE 		: 'Download Image (PNG)',
		DOWNLOAD_JPEG_IMAGE		: 'Download Image (JPEG)',
		DOWNLOAD_PDF_DOC 		: 'Download Document (PDF)',
		DOWNLOAD_SVG_IMAGE 		: 'Download Vector Image (SVG)',
		DOWNLOAD_CSV_DOC 		: 'Download Data (CSV)',
		DOWNLOAD_XLSX_DOC 		: 'Download Data (XLSX)',
	...
	DASH : {
		...
		TYPE_FORMS 		: 'Forms',
		TYPE_RESULTS 	: 'Form Templates',
		TYPE_RESULTS_GRP: 'Result Templates',
		VIEW		 	: 'View',
